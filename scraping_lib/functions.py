...
def get_possible_leagues(league, season, page):
    """Diccionario con todas las páginas, ligas y temporadas posibles para el scraper.
        También contiene algunas excepciones para evitar errores como una liga o página que no forma parte del scraper.

        Args:
            liga (str): Liga a scrapear
            season (str): Temporada a analizar
            page (str): Página a consultar

        Se muestra:
            InvalidStrType: Si un parámetro no es una cadena
            InvalidLeagueException: Si una liga no está dentro de todas las posibles
            InvalidSeasonException: Si una temporada no está dentro de todas las posibles temporadas

        Returns:
            dict: diccionario con las posibles ligas
    """
    possible_leagues = {
        'Fbref': {
            'Copa de la Liga': {
...
def get_possible_leagues_for_page(league, season, page):
    """Obtener posibles ligas para una página determinada
    ...
    Returns:
        dict: ligas que son posibles para esa página.
    """
