...
# Configuración de headers para las solicitudes HTTP
headers = {
...
# Definición de paleta de colores personalizada: bordo a blanco
...
# Registro de mapa de colores granate a blanco
...
# Definición de paleta de colores personalizada: escala de verdes
colors = [
    '#d0d6d4',
    '#c5d0cd',
    '#bbcac7',
...
# Registro de mapa de colores SOC
